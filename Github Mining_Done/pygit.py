'''
For this file you have to take secret key from github and then you can work on it. Thanks
...
USER = 'You have to put your required user name'
# REPO = 'Hook'
ORG  = 'it belongs to which organisaton.'
